...
window.GiveVoteForCandidate = function(candidate) {
  ...
  Voting.deployed().then(function(contractInstance) {
    contractInstance.GiveVoteForCandidate(candidateName, voteTokens, {gas: 2000000, from: web3.eth.accounts[0]}).then(function() {
      let div_id = candidates[candidateName];
      return contractInstance.totalVotesForCandidate.call(candidateName).then(function(v) {
...
function populateCandidateVotes() {
  ...
  for (var i = 0; i < candidateNames.length; i++) {
    ...
    Voting.deployed().then(function(contractInstance) {
      contractInstance.totalVotesForCandidate.call(name).then(function(v) {
...
function populateTokenData() {
  ...
  Voting.deployed().then(function(contractInstance) {
    ...
    contractInstance.tokensSold.call().then(function(v) {
      ...
      $("#tokens-add").html(address);
    });
    contractInstance.voterDetails.call(address).then(function(v) {
      $("#tokens-purchase").html(v[0].toString());
    });
